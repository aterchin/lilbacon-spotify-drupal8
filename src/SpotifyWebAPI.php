...
/**
 * @file
 * Contains Drupal\lilbacon_spotify\SpotifyWebAPI
 */
 
namespace Drupal\lilbacon_spotify;

use Drupal\lilbacon_spotify\SpotifyRequest;
...
class SpotifyWebAPI
{
    ...
    /**
     * Constructor
     * Set up SpotifyRequest object.
     *
     * @param SpotifyRequest $request Optional. The SpotifyRequest object to use.
     */
    public function __construct($request = null)
    {
        $this->request = $request ?: new SpotifyRequest();
    }
    ...
    /**
     * Get the return type for the SpotifyRequest body element.
     *
    ...
    /**
     * Get the SpotifyRequest object in use.
     *
     * @return SpotifyRequest The SpotifyRequest object in use.
     */
    public function getSpotifyRequest()
    {
        return $this->request;
    }
    ...
    /**
     * Set the return type for the SpotifyRequest body element.
     *
